...
os.makedirs('telegram-tracker/logs', exist_ok=True)

# Set up logging
logging.basicConfig(filename='telegram-tracker/logs/telegram_scraper.log', level=logging.INFO,
...
logging.info(f'Data collection complete for: {channel}')
